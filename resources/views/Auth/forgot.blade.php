...
<head>
    ...
    <title>Forgot Password - Coventry Metro Credit Union</title>
                        ...
                        <div class="col-md-offset-3 col-md-6 col-sm-offset-2 col-sm-8 col-xs-12">
                            <div class="login-form">
                                <h4 class="login-title text-center">Forgot Password?</h4>
                                 <h6 class="font-weight-light" style="font-size:14px;">Enter your registered email to get reset password link</h6>
                                <div class="row">
                                    
                                    <form id="login-form" method="POST" action="{{route('login')}}" class="log-form">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <input type="text" id="email" class="form-control monitor" placeholder="Enter your Email"
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                                            <button type="submit" id="submit" class="slide-btn login-btn" >
                                                ...
                                                <span id="msg">Send Reset Link</span>
                                            </button>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                                            ...
                                            <div class="sign-icon">
                                                ...
                                                <div class="acc-not">Go back -  <a href="{{route('login')}}">login</a></div>
                                            </div>
                                        </div>
                                    </form>
                                </div>
